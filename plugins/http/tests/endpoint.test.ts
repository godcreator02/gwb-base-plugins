...
import { DEFAULT_HOME_PORT, choosePort, defaultPort, endpointUrl, homeNameOf } from '../src/endpoint.js'
...
describe('choosePort：default home', () => {
  ...
  it('显式给了口就用那个,照样不退让——退让就是把车道送给占口的那个 home', () => {
...
describe('endpointUrl', () => {
  it('钉死 127.0.0.1,不带路径——两条路由都挂在基址下', () => {
    expect(endpointUrl(2870)).toBe('http://127.0.0.1:2870')
  })
})
